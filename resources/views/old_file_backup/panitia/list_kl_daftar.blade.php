...
<div class="row mb-2">
  <div class="col-sm-6">
    <h4 class="judul ml-2" style="font-weight: 600;">Verifikasi <small style="font-size: 12px; color: #777;">Daftar Kolokium</small></h3>
  </div>
</div>
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h1 class="card-title" style="font-weight: 600; font-size: 1.2rem;">Data <small style="font-size: 12px; color: #777;">Daftar Kolokium</small></h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">
          <!-- <h5 class="card-title">Profile</h5> -->
          <h1 class="card-title" style="font-weight: 600; font-size: 1.2rem;">History <small style="font-size: 12px; color: #777;">Daftar Kolokium</small></h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" style="font-size: 12px; color: #333; clear: both;">
              ...
              <div class="col-sm-12">
                <div class="table-responsive">
                  <table id="datatable2" class="table table-striped table-bordered nowrap dataTable no-footer dtr-inline collapsed" style="font-size: 12px; font-weight: 400; color: black; width: 100%;" width="100%" role="grid" aria-describedby="data-table_info">
                    ...
                    <tbody>
                      @for($i=0; $i < count($kolokium2); $i++) <tr>
                        <td style="text-align: center;">{{$i + 1}}</td>
                        <td>{{$kolokium2[$i][1]}}</td>
