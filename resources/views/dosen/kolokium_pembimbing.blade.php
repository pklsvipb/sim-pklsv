          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="title text-center" style="font-weight: 600;"> REQUEST PENGISIAN BAP PEMBIMBING KOLOKIUM</div>
              </div>
            </div>
            @if (count($mhs) == 0)
            <div class="div text-secondary text-center">
              <h1 style="font-size: 12px;">Tidak Ada Request Pengisian BAP Pembimbing Kolokium</h1>
            </div>
            @else
            <?php for ($i = 0; $i < count($mhs); $i++) { ?>
              <div class="row" style="background-color: #b3bfff; border-radius: 5px; margin: 0px 10% 2% 10%;">
                ...
                <div class="col-md-2 pt-4 mt-3">
                  <a href="{{route('kl-bap-d',$mhs[$i][0])}}" type="button" class="btn btn-success btn-md">INPUT BAP</a>
                </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="title text-center" style="font-weight: 600;"> HISTORY BAP PEMBIMBING KOLOKIUM</div>
              </div>
            </div>
            <table class="table" cellspacing="0" cellpadding="0" style="font-size: .875rem; font-weight: 600;">
              ...
              for ($i=0; $i < count($mhs2);$i++) { ?>
                <tr>
                  ...
                  <td>
                    <a type="button" href="{{url('dosen/dospem/bap-kl/view-pdf', $mhs2[$i][5])}}" class="btn btn-success btn-sm">Download</a>
                    <a type="button" href="{{url('dosen/dospem/bap-kl/edit', $mhs2[$i][5])}}" class="btn btn-primary btn-sm">Edit</a>
                  </td>
                </tr>
              <?php  
              $no += 1; } ?>
            ...
            <table class="table text-center" cellspacing="0" cellpadding="0" style="font-size: .875rem; font-weight: 600;">
              ...
              for ($i=0; $i < count($mhs3);$i++) { ?>
                <tr>
                  ...
                  <td>
                    <a type="button" href="{{url('dosen/dospem/bap-kl/edit', $mhs3[$i][5])}}" class="btn btn-primary btn-sm">Update</a>
                  </td>
                </tr>
              <?php  
              $no += 1; } ?>
