...
<head>
  ...
  <title>Dosen Supervisi PKL</title>
  <style>
    body {
...
<body>
    ...
    <tbody>
      ...
      <tr>
        <td colspan="3" style="text-align: center; padding-top: 0px;">
          ...
          <p style="margin-bottom: -7px;"><b>LAPORAN SUPERVISI PKL</b></p>
  ...
  <table class="table table-borderless" style="margin-top: -1.4em;">
    <tbody>
      <tr>
        <td width="30%" style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
        ...
        <td width="1%" style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -3em;">:</p>
        </td>
        <td width="69%" style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -4em;">{{ $daftar->instansi }}</p>
        </td>
      </tr>
      <tr>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
        ...
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -4em;">{{ $daftar->alamat_instansi }}</p>
        </td>
      </tr>
      <tr>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt;">Bidang Usaha/Kegiatan</p>
        </td>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -3em;">:</p>
        </td>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -4em;">{{ $daftar->bidang_usaha }}</p>
        </td>
      </tr>
      <tr>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt;">Dosen Supervisi</p>
        </td>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -3em;">:</p>
        </td>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -4em;">{{ $supervisi->getDosen->nama }}</p>
        </td>
      </tr>
      <tr>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt;">Tanggal Supervisi</p>
        </td>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -3em;">:</p>
        </td>
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -4em;">{{ Carbon\Carbon::parse($daftar->tanggal)->translatedFormat('d F Y'); }}</p>
        </td>
      </tr>
    </tbody>
  </table>

  <table class="table table-bordered" style="margin-top: -.80rem;">
    <tbody>
      <tr>
      ...
      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">1</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">Perkembangan Usaha / Kegiatan 3 tahun terakhir</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
      ...
      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">2</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">Perencanaaan Usaha / Kegiatan di masa yang akan datang</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
      ...
      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">3</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">Kegiatan Perusahaan / Instansi</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
        ...
        @if ($supervisi->penilaian_3 == "Cukup Aktif")
          <p style="font-size: 10pt; margin-top: -1.2rem;">b.<i class="far fa-circle" style="margin-top: .33rem; margin-left: -4.3%;"></i> Cukup Aktif</p>
        @else
          <p style="font-size: 10pt; margin-top: -1.2rem;">b. Cukup Aktif</p>
        @endif
        @if ($supervisi->penilaian_3 == "Kurang Aktif")
          <p style="font-size: 10pt; margin-top: -1.2rem; margin-bottom: -.01rem;">c.<i class="far fa-circle" style="margin-top: .33rem; margin-left: -4.3%;"></i> Kurang Aktif</p>
        @else
          <p style="font-size: 10pt; margin-top: -1.2rem; margin-bottom: -.01rem;">c. Kurang Aktif</p>
        @endif
        </td>
      </tr>

      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">4</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">Penerimaan Perusahaan / Instansi</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
        ...
        @if ($supervisi->penilaian_4 == "Cukup Mendukung")
          <p style="font-size: 10pt; margin-top: -1.2rem;">b.<i class="far fa-circle" style="margin-top: .33rem; margin-left: -4.3%;"></i> Cukup Mendukung</p>
        @else
          <p style="font-size: 10pt; margin-top: -1.2rem;">b. Cukup Mendukung</p>
        @endif
        @if ($supervisi->penilaian_4 == "Kurang Mendukung")
          <p style="font-size: 10pt; margin-top: -1.2rem; margin-bottom: -.01rem;">c.<i class="far fa-circle" style="margin-top: .33rem; margin-left: -4.3%;"></i> Kurang Mendukung</p>
        @else
          <p style="font-size: 10pt; margin-top: -1.2rem; margin-bottom: -.01rem;">c. Kurang Mendukung</p>
        @endif
        </td>
      </tr>

      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">5</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">Kelayakan sebagai tempat PKL selanjutnya</td>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
        ...
        @if ($supervisi->penilaian_5 == "Tidak Layak")
          <p style="font-size: 10pt; margin-top: -1.2rem; margin-bottom: -.01rem;">c.<i class="far fa-circle" style="margin-top: .33rem; margin-left: -4.3%;"></i> Tidak Layak</p>
        @else
          <p style="font-size: 10pt; margin-top: -1.2rem; margin-bottom: -.01rem;">c. Tidak Layak</p>
        @endif
        </td>
      </tr>

      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">6</td>
        <td colspan="2" style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
      ...
      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">7</td>
        <td colspan="2" style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
      ...
      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">8</td>
        <td colspan="2" style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
        Masalah yang dihadapi mahasiswa berkaitan dengan PKL :
        @if ($value8[0] == "Tidak ada")
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value8[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. -------------------------------------------------------- </p>
        @elseif ($value8[0] != "Tidak ada" && empty($value8[1]) )
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value8[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. -------------------------------------------------------- </p>
        @elseif ($value8[0] != "Tidak ada" && !empty($value8[1]) )
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value8[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. {{$value8[1]}} </p>
        @endif
        </td>
      </tr>

      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">9</td>
        <td colspan="2" style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
        Harapan mahasiswa untuk PKL selanjutnya :
        @if ($value9[0] == "Tidak ada")
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value9[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. -------------------------------------------------------- </p>
        @elseif ($value9[0] != "Tidak ada" && empty($value9[1]) )
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value9[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. -------------------------------------------------------- </p>
        @elseif ($value9[0] != "Tidak ada" && !empty($value9[1]) )
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value9[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. {{$value9[1]}} </p>
        @endif
        </td>
      </tr>

      <tr>
        <td style="padding: 1px; padding-left: 10px; font-size: 10pt; text-align: center;">10</td>
        <td colspan="2" style="padding: 1px; padding-left: 10px; font-size: 10pt; line-height: 110%;">
        Lain-lain :
        @if ($value10[0] == "Tidak ada")
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value10[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. -------------------------------------------------------- </p>
        @elseif ($value10[0] != "Tidak ada" && empty($value10[1]) )
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value10[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. -------------------------------------------------------- </p>
        @elseif ($value10[0] != "Tidak ada" && !empty($value10[1]) )
          <p style="font-size: 10pt; margin-bottom: -.10rem;">a. {{$value10[0]}}</p>
          <p style="font-size: 10pt; margin-bottom: -.10rem;">b. {{$value10[1]}} </p>
        @endif
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td width="100%" style="padding-top: 1px; margin-top: -.1rem;">
          <p style="margin-bottom: -.45em; margin-left: 23em; margin-right: 0px; font-size: 10pt;">Bogor, {{ Carbon\Carbon::parse($supervisi->tanggal_supervisi)->translatedFormat('d F Y'); }}</p>
          <p style="margin-bottom: -.10em; margin-left: 23em; margin-right: 0px; font-size: 10pt;">Dosen Supervisi</p>
          ...
          <p style="margin-bottom: -.10em; margin-left: 23em; margin-right: 0px; font-size: 10pt;">NPI. {{$supervisi->getDosen->nip}}</p>
        </td>
        <td></td>
        <td></td>
      </tr>
  ...
  <table class="table table-borderless" style="position: absolute; bottom: 40px;">
    <tbody>
      <tr>
          ...
          <table class="table table-bordered" id="footer">
            <tbody>
              <tr>
                ...
                <td style="padding-top:1px; font-size: 10pt; text-align: center; font-family: Arial, Helvetica, sans-serif;" width="10%">Hal: 1/3</td>
