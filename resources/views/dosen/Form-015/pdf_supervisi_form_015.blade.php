  ...
  <table class="table table-borderless" style="margin-top: -1.4em;">
    <tbody>
      ...
      <tr>
        ...
        <td style="padding-top: 1px; padding-bottom: 1px; line-height: 100%;">
          <p style="margin-bottom: 0em; font-size: 10pt; margin-left: -4em;">{{ Carbon\Carbon::parse($supervisi->tanggal)->translatedFormat('d F Y'); }}</p>
        </td>
      </tr>
    </tbody>
  </table>
    ...
    <tbody>
      <tr>
        <td width="100%" style="padding-top: 1px; margin-top: -.1rem;">
          ...
          <img src="{{public_path($supervisi->getDosen->ttd)}}" style="margin-left: 18em; margin-top: 7px; width: auto; height: 1.5cm;">
