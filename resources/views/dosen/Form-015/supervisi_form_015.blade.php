        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="div text-secondary text-center">
              <h1 style="font-size: 12px;">Tidak Ada Request Pengisian Supervisi Form 015</h1>
            </div>
            @else
            <?php for ($i = 0; $i < count($mhs); $i++) { ?>
              <div class="row" style="background-color: #b3bfff; border-radius: 5px; margin: 0px 10% 2% 10%;">
                ...
                <div class="col-sm-4 pt-4 mt-2">
                  ...
                  <a href="{{route('input-form-015',$mhs[$i][0])}}" type="button" class="btn btn-success btn-md">INPUT</a>
                </div>
              </div>
            <?php } ?>
            @endif
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="title text-center" style="font-weight: 600;"> HISTORY SUPERVISI FORM 015</div>
              </div>
            </div>
