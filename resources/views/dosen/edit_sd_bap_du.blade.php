  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-11" style="margin: auto;">
        ...
        <form action="{{ url('/dosen/update/sidang2-bap-dospem', $bap->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-12 mb-5">
                  <div class="title text-center" style="font-weight: 600;"> EDIT PENGISIAN BAP SIDANG </div>
                  <div class="div">
                    ...
                    <thead>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>20%</td>
                          <td><input type="number" class="form-control" name="nilai1" required value="{{$bap->nilai1}}"></td>
                        ...
                        <tr>
                          ...
                          <td>40%</td>
                          <td><input type="number" class="form-control" name="nilai2" required value="{{$bap->nilai2}}"></td>
                        ...
                        <tr>
                          ...
                          <td>40%</td>
                          <td><input type="number" class="form-control" name="nilai3" required value="{{$bap->nilai3}}"></td>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-12 mb-5">
                  <div class="title text-center" style="font-weight: 600;"> EDIT PENGISIAN FORM 025  PENILAIAN LAPORAN AKHIR </div>
                  <div class="div">
                    <table cellspacing="0" cellpadding="3" style="font-size: .875rem; font-weight: 600; margin: 50px 0px;">
                      <tbody>
                        <tr>
                    ...
                    <table class="table table-bordered text-center" cellspacing="0" cellpadding="0" style="font-size: .875rem; font-weight: 600;">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>10%</td>
                          <td><input type="number" class="form-control" name="form_nilai1" required value="{{$form->nilai1}}"></td>
                        ...
                        <tr>
                          ...
                          <td>80%</td>
                          <td><input type="number" class="form-control" name="form_nilai2" required value="{{$form->nilai2}}"></td>
                        ...
                        <tr>
                          ...
                          <td>10%</td>
                          <td><input type="number" class="form-control" name="form_nilai3" required value="{{$form->nilai3}}"></td>
                    ...
                    <table>
                      <tr>
                        ...
                        <td><input type="number" class="form-control" name="nilai_jurnal" required value="{{$form->nilai_jurnal}}"></td>
                      </tr>
                    </table>
