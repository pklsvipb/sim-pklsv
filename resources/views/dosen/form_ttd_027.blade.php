...
<div class="row mb-2">
  <div class="col-sm-6">
    <h4 class="judul ml-2" style="font-weight: 600;">Request Tanda Tangan Form 027 <small style="font-size: 12px; color: #777;"></small></h3>
  </div>
</div>
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h1 class="card-title" style="font-weight: 600; font-size: 1.2rem;">Dosen Pembimbing</h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                  ...
                  <table id="datatable1" class="table table-striped table-bordered nowrap dataTable no-footer dtr-inline collapsed" style="font-size: 12px; font-weight: 400; color: black; width: 100%;" width="100%" role="grid" aria-describedby="data-table_info">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $form[$i][5] }}</td>
                        <td>
                          <a href="{{ asset($form[$i][3]) }}" type="button" class="btn btn-info" style="font-size: 13px;"><i class="fas fa-file-pdf"></i> {{ substr($form[$i][3], 4) }}</a>
                        </td>
                        <td style="text-align: center;">
                          <form action="{{route('form-ttd-027-submit-dosbim', $form[$i][0])}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
      ...
      <div class="card">
        <div class="card-header">
          <!-- <h5 class="card-title">Profile</h5> -->
          <h1 class="card-title" style="font-weight: 600; font-size: 1.2rem;">Dosen Penguji</h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                  ...
                  <table id="datatable2" class="table table-striped table-bordered nowrap dataTable no-footer dtr-inline collapsed" style="font-size: 12px; font-weight: 400; color: black; width: 100%;" width="100%" role="grid" aria-describedby="data-table_info">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $form2[$i][5] }}</td>
                        <td>
                          <a href="{{ asset($form2[$i][3]) }}" type="button" class="btn btn-info" style="font-size: 13px;"><i class="fas fa-file-pdf"></i> {{ substr($form2[$i][3], 4) }}</a>
                        </td>
                        <td style="text-align: center;">
                          <form action="{{route('form-ttd-027-submit-dosji', $form2[$i][0])}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <button type="submit" class="btn btn-success btn-sm"><i class="fas fa-check"></i></button>
                          </form>
                        </td>
