            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                ...
                <div class="div">
                  ...
                  <form action="{{ url('/dosen/update/kolokium-bap-dospem', $bap->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="keputusan" id="proses" value="proses" {{ ($bap->keputusan == "proses") ? "checked" : "" }}>
                      <label class="form-check-label" for="proses">
                        Proses PKL
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="keputusan" id="ulang" value="ulang" {{ ($bap->keputusan == "ulang") ? "checked" : "" }}>
