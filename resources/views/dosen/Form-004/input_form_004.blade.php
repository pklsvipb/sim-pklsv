                ...
                <div class="div">
                  <table cellspacing="0" cellpadding="3" style="font-size: .875rem; font-weight: 600; margin: 50px 0px;">
                    <tbody>
                      ...
                      <tr>
                        <td>Dosen Penjajakan Lokasi PKL</td>
                        <td>:</td>
                        <td>{{$userData->nama}}</td>
                      </tr>
                      <tr>
                 ...
                 <form action="{{ url('/dosen/submit/supervisi/form004', $supervisi->id) }}" method="POST" class="form-horizontal">
                    {{ csrf_field() }}
                    <table class="table table-bordered" style="font-size: .875rem; font-weight: 600; margin: 50px 0px;">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>Perkembangan Usaha 3 tahun terakhir</td>
                          <td>
                        ...
                        <tr>
                          <td>2</td>
                          <td>Perencanaaan Usaha di masa yang akan datang</td>
                          <td>
                        ...
                        <tr>
                          <td>5</td>
                          <td>Kelayakan sebagai lokasi PKL</td>
                          <td>
                            <div class="form-check">
