            ...
            <?php for ($i = 0; $i < count($mhs); $i++) { ?>
              <div class="row pt-4" style="background-color: #b3bfff; border-radius: 5px; margin: 0px 10% 2% 10%;">
                ...
                <div class="col-md-4 mt-3">
                  <a href="{{route('sd-bap-j',$mhs[$i][0])}}" type="button" class="btn btn-success btn-md">INPUT NILAI BAP</a>
                </div>
              </div>
            <?php } ?>
            @endif
          ...
          <div class="card-body">
            ...
            <?php for ($i = 0; $i < count($mhs3); $i++) { ?>
              <div class="row pt-4" style="background-color: #b3bfff; border-radius: 5px; margin: 0px 10% 2% 10%;">
                ...
                <div class="col-md-4 mt-3">
                  <a href="{{route('sd-bap-ju',$mhs3[$i][0])}}" type="button" class="btn btn-success btn-md">INPUT NILAI BAP</a>
                </div>
              </div>
            <?php } ?>
            @endif
