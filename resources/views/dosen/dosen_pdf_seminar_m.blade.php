  ...
  <table class="table table-borderless">
    <tbody>
      <tr>
        ...
        <td width="20%">
          <p style="text-align: right; font-family: Arial, Helvetica, sans-serif; font-size: 10pt;">FRM/SV/PKL/019</p>
        </td>
      </tr>
      <tr>
          ...
          <table class="table table-bordered" id="nilai" style="margin-top: -1em;">
            ...
            <tbody>
              <tr>
                ...
                <td style="font-size: 11pt; text-align: center;"><?= $bap->nilai1 * 0.03; ?></td>
              </tr>
              <tr>
                ...
                <td style="font-size: 11pt; text-align: center;"><?= $bap->nilai2 * 0.03; ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style="font-size: 11pt; text-align: center;"><?= ($bap->nilai1 * 0.03) + ($bap->nilai2 * 0.03) + ($bap->nilai3 * 0.04); ?></td>
              </tr>
            </tbody>
          </table>
        </td>
