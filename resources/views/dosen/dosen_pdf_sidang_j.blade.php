...
<head>
  ...
  <title>Dosen Penguji Sidang PDF</title>
  <style>
    body {
          ...
          <table class="table table-bordered" id="nilai" style="margin-top: -1em;">
            <thead>
              <tr>
                ...
                <th colspan="2" style="font-size: 11pt; font-weight: 600; text-align: center;" width="25%">Dosen Penguji</th>
              </tr>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td style="font-size: 11pt; text-align: center;"><?= $bap->nilai1 * 0.02; ?></td>
              </tr>
              <tr>
                ...
                <td style="font-size: 11pt; text-align: center;"><?= $bap->nilai2 * 0.04; ?></td>
              </tr>
              <tr>
                ...
                <td style="font-size: 11pt; text-align: center;"><?= $bap->nilai3 * 0.04; ?></td>
              </tr>
              <tr>
                <td style="font-size: 11pt; text-align: center;" colspan="2">Total</td>
                <td style="font-size: 11pt; text-align: center;">100%</td>
                <td style="font-size: 11pt; text-align: center;"><?= number_format((($bap->nilai1 +  $bap->nilai2 + $bap->nilai3) / 3),2); ?></td>
                <td style="font-size: 11pt; text-align: center;"><?= ($bap->nilai1 * 0.02) + ($bap->nilai2 * 0.04) + ($bap->nilai3 * 0.04); ?></td>
              </tr>
            </tbody>
          </table>
        </td>
