...
<div class="row mb-2">
  <div class="col-sm-6">
    <h4 class="judul ml-2" style="font-weight: 600;">Request Tanda Tangan Form Persetujuan Seminar <small style="font-size: 12px; color: #777;"></small></h3>
  </div>
</div>
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h1 class="card-title" style="font-weight: 600; font-size: 1.2rem;">Persetujuan Seminar<small style="font-size: 12px; color: #777;"> Tanda Tangan Dosen Pembimbing</small></h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                          <form action="{{route('form-ttd-submit', $form[$i][0])}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
