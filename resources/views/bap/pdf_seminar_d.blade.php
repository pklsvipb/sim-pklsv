    ...
    <tbody>
      ...
      <tr>
        ...
        <td width="80%" style="text-align:center;">
          ...
          <p style="margin-bottom: -6px; font-family: Arial, Helvetica, sans-serif; font-size: 12pt;"> <b> SEKOLAH VOKASI </p>
        ...
        <td width="5%">
          <!--<p style="margin-top: 15px; text-align: right; font-family: Arial, Helvetica, sans-serif; font-size: 10pt;">FRM/SV/PKL/019</p>-->
        </td>
      </tr>
      <tr>
