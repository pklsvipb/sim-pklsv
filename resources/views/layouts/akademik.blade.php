      ...
      <ul class="navbar-nav ml-auto" style="margin-right: 10px;">
        <li class="dropdown navbar-user">
          ...
          <ul class="dropdown-menu">
            <li style="text-decoration: none; font-size: 12px; border-bottom: 1px solid black; padding: 10px 10px 10px;"><a href="{{ route('reset-a') }}" style="color: black;"><i class="fas fa-lock fa-sm"></i> &nbsp;Change Password</a></li>
