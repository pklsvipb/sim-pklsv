...
<div class="row mb-2">
  <div class="col-sm-6">
    <form action="{{ url('/akademik/bap-seminar/filter') }}" method="POST" class="form-horizontal ml-2 mr-2">
      @csrf
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                          @if ($data[$i][3] != 0) 
                          <a href="{{route('download-bap-seminar-d',$data[$i][3])}}" type="button" class="btn btn-primary btn-sm" style="font-size: 12px;">BAP DOSPEM</a> &nbsp; 
                          @else 
                          <span></span> 
                          @endif 
 
                          @if ($data[$i][4] != 0) 
                          <a href="{{route('download-bap-seminar-m',$data[$i][4])}}" type="button" class="btn btn-primary btn-sm" style="font-size: 12px;">BAP MODERATOR</a> &nbsp; 
                          @else 
                          <span></span> 
                          @endif 
                          ...
                          <a href="{{route('download-bap-seminar-d',$data[$i][3])}}" type="button" class="btn btn-primary btn-sm">BAP DOSEN</a> &nbsp;
                          <a href="{{route('download-bap-seminar-m',$data[$i][4])}}" type="button" class="btn btn-primary btn-sm">BAP MODERATOR</a> --}}
                        </td>
                      </tr>
                      @endfor
                    </tbody>
