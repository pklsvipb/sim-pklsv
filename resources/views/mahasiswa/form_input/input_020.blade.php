            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                ...
                <table cellspacing="0" cellpadding="3" style="font-size: .875rem; font-weight: 600; margin: 50px 0px;">
                  <tbody>
                    <tr>
                      <td width="20%">Nama Pembahas</td>
                      <td>:</td>
                      <td width="80%"><input type="text" name="nama_bahas" class="form-control"></td>
                    </tr>
                    <tr>
                      <td>NIM</td>
                      <td>:</td>
                      <td><input type="text" name="nim_bahas" class="form-control"></td>
                    </tr>
                    <tr>
                      <td>Hari / Tanggal</td>
                      <td>:</td>
