              ...
              <div class="col-md-12 mb-5">
                ...
                <table cellspacing="0" cellpadding="3" style="font-size: .875rem; font-weight: 600; margin: 50px 0px;">
                  <tbody>
                    <tr>
                      <td>
                        Silakan isi FORM 010 (Laporan Periodik PKL) pada menu form daily terlebih dahulu. Jika telah diisi dan ditanda tangani oleh pembimbing lapangan, maka upload file form tersebut disini (jadikan satu file berformat file pdf).
                        <br>
