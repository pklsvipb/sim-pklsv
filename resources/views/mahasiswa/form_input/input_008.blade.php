              ...
              <div class="col-md-12 mb-5">
                ...
                <table cellspacing="0" cellpadding="3" style="font-size: .875rem; font-weight: 600; margin: 50px 0px;">
                  <tbody>
                    <tr>
                      <td>
                        Silakan unduh format FORM 005 (Daftar Kehadiran PKL) terlebih dahulu. Isi bersama teman kelompok instansi kalian, jika telah diisi dan ditanda tangani oleh instansi, maka upload file form tersebut disini (jadikan satu file berformat file pdf).
                        <br>
