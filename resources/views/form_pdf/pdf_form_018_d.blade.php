...
<head>
  ...
  <title>Form 018 PDF TTD Dospem</title>
  <style>
    body {
...
<body>
  ...
  <table class="table table-borderless">
    <tbody>
      <tr>
        <td colspan="3">
          <p style="margin-bottom: -50%; text-align: right; font-family: Arial, Helvetica, sans-serif; font-size: 10pt;">FRM/SV/PKL/018</p>
        </td>   
      </tr>
      <tr>
        <td width="15%">
      ...
      <tr>
        <td colspan="3" style="text-align: center;">
          ...
          <p style="margin-bottom: -7px;"><b>PERSETUJUAN SEMINAR HASIL PKL</b></p>
  ...
  <table class="table table-borderless" style="margin-top: 1em; height: 13%;">
    <tbody>
      ...
      <tr>
        <td style="padding-top: 1px; padding-bottom: 1px;"></td>
        <td style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">Judul Laporan PKL</p></td>
        <td style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">:</p></td>
  ...
  <table class="table table-borderless" style="margin-top: -1em;">
    <tbody>
      <tr>
        <td width="22%" style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">telah layak melaksanakan seminar hasil PKL dengan jadwal:</p></td>
      </tr>
  </table>
  ...
  <table class="table table-borderless" style="margin-top: 1em; height: 8%;">
    <tbody>
      <tr>
        <td width="6%" style="padding-top: 1px; padding-bottom: 1px;"></td>
        <td width="28%" style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">Hari</p></td>
        <td width="1%" style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">:</p></td>
        <td width="65%" style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt; margin-left: -1em;">{{ Carbon\Carbon::parse($tanggal)->translatedFormat('l'); }}</p></td>
      </tr>
      <tr>
        <td style="padding-top: 1px; padding-bottom: 1px;"></td>
        <td style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">Tanggal</p></td>
        <td style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">:</p></td>
        <td style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt; margin-left: -1em;">{{ Carbon\Carbon::parse($tanggal)->translatedFormat('d F Y'); }}</p></td>
      </tr>
      </tr>
    </tbody>
  </table>
    ...
    <tbody>
      <tr>
        <td width="100%">
          ...
          <p style="margin-bottom: 0em; font-size: 11pt;">NPI {{$data->getDospem1->nip}}</p>
        </td>
      </tr>
    </tbody>
  </table>
