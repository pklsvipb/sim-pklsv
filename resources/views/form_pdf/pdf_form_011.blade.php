...
<body>
  ...
  <table class="table table-borderless">
    <tbody>
      <tr>
        <td colspan="3">
          <p style="margin-bottom: -50%; text-align: right; font-family: Arial, Helvetica, sans-serif; font-size: 10pt;">FRM/SV/PKL/011</p>
        </td>   
      </tr>
      <tr>
        <td width="15%">
      ...
      <tr>
        <td colspan="3" style="text-align: center;">
          ...
          <p style="margin-bottom: -7px;"><b>FORM PRESENTASI HASIL PKL</b></p>
  ...
  <table class="table table-borderless" style="margin-top: -2em;">
    <tbody>
      <tr>
        <td width="22%" style="padding-top: 1px; padding-bottom: 1px;"><p style="margin-bottom: 0em; font-size: 11pt;">telah melakukan presentasi hasil PKL pada tanggal {{ Carbon\Carbon::parse($tanggal)->translatedFormat('d F Y'); }} dengan judul Laporan Akhir : {{ $judul }}</p></td>
      </tr>
  </table>
