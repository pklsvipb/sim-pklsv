...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <form action="{{route('seminar-vfs', $id_mhs)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="card">
            <div class="card-body">
              ...
              <table class="table" cellspacing="0" cellpadding="0" style="font-size: .875rem; font-weight: 600;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @else
                    <td style="text-align: center;"><a href="{{ asset($file[$id][3]) }}"><i class="fas fa-file-word fa-lg"></i></a></td>
