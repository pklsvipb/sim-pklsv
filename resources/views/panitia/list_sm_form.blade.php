...
<div class="row mb-2">
  <div class="col-sm-6">
    <h4 class="judul ml-2" style="font-weight: 600;">Verifikasi <small style="font-size: 12px; color: #777;">Seminar</small></h3>
  </div>
</div>
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h1 class="card-title" style="font-weight: 600; font-size: 1.2rem;">Data <small style="font-size: 12px; color: #777;">Seminar</small></h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
