                    ...
                    <tbody> 
                      ...
                      <tr> 
                        ...
                        <td style="text-align: center;"> 
                          @if ($data[$i][2] != 0) 
                          <a href="{{route('download-bap-sddu',$data[$i][2])}}" type="button" class="btn btn-primary btn-sm" style="font-size: 10.5px;">DOSPEM</a> &nbsp; 
                          <a href="{{route('download-sdu-form025', $data[$i][2])}}" style="font-size: 10.5px;" class="btn btn-primary btn-sm">FORM 025</a> &nbsp;
                          @else 
                          <span></span> 
                          @endif 
