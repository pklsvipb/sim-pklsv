            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="table-responsive">
                  <table id="datatable" class="table table-striped table-bordered dataTable no-footer dtr-inline collapsed" style="font-size: 12px; font-weight: 400; color: black; width: 100%;" width="100%" role="grid" aria-describedby="data-table_info"> 
                    <thead> 
                      <tr> 
                        <th width="5%">No</th> 
                    ...
                    <tbody> 
                      ...
                      <tr> 
                        ...
                        <td style="text-align: center;"> 
                          @if ($data[$i][2] != 0) 
                          <a href="{{route('download-bap-kld',$data[$i][2])}}" type="button" class="btn btn-primary btn-sm" style="font-size: 10.5px;">BAP DOSPEM</a> &nbsp; 
                          @else 
                          <span></span> 
                          @endif 
 
                          @if ($data[$i][3] != 0) 
                          <a href="{{route('download-bap-klm',$data[$i][3])}}" type="button" class="btn btn-primary btn-sm" style="font-size: 10.5px;">BAP MODERATOR</a> &nbsp; 
                          @else 
                          <span></span> 
                          @endif 
