          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                ...
                @else
                <form action="{{ route('kolokium-vds', $daftar->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <table class="table" cellspacing="0" cellpadding="0" style="font-size: .875rem; font-weight: 600;">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><input type="text" class="form-control" style="font-weight: 700;" value="{{$daftar->lokasi}}" name="lokasi" disabled></td>
                      </tr>
